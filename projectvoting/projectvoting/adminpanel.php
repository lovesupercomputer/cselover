...
<body onload="document.adminpanel.name.focus();"
...
<form name="adminpanel" action='#' method='post'>
<center><legend><span style="color:green" size="48px"><h1><u><strong>Administrator Login</strong></u></h1></span></legend></center>
<table style="width:50%" cellspacing='0' cellpadding="05" align='center' border="025" bgcolor="#94B9E2" class="grid" >
<tr><td width="39%" align="right"><strong>User name&nbsp;</strong><span style="color:red;" size="68">*</span></td>
<td><input type='text' name='name' placeholder="User Name" maxlength="19" /></td></tr>
<tr><td width="39%" align="right"><strong>Password&nbsp;</strong><span style="color:red;" size="88">*</span></td>
<td><input type='password' name='pwd'  placeholder="Password" maxlength="19"/></td></tr>
...
if(isset($_POST['submit']))
{
 ...
 if($name!=''&&$pwd!='')
 {
   ...
   else
   {
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  You entered Username or Password is Incorrect!!!</font>';
   }
 }
 else
 {
  echo'<font color="red"; size="06">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	Enter both Username and Password!!!</font>';
 }
}
?>
